...
if WORKER_COUNT != 3:
    raise ValueError(
        "The trio project requires exactly 3 workers"
    )
...
for value in (
    ...
    if value < 0 or value > 1:
        raise ValueError(
            "router fault probabilities "
            "must be between 0 and 1"
        )


STATS_INTERVAL_SEC = _env_int(
    "STATS_INTERVAL_SEC",
    10,
)
