...
def start_router() -> None:
    ...
    for port in RX_PORT_LIST:
        ...
        # select() tells us when data exists.
        # Non-blocking mode then allows us to drain
        # every packet already waiting in the socket.
    ...
    while not shutdown:
        ...
        for sock in readable:
            ...
            # IMPORTANT:
            #
            # Drain all datagrams currently waiting in
            # this UDP socket before going back to select().
            #
            # This reduces self-inflicted router loss
            # during a large sustained transfer.
            while True:
                try:
